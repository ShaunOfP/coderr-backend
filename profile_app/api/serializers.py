...
class ProfileSerializer(serializers.ModelSerializer):
    """Serializes the fields for the endpoint /api/profile/{pk}/"""
...
class BusinessProfileSerializer(serializers.ModelSerializer):
    """Serializes the fields for the endpoint /api/profiles/business/"""
    user = serializers.IntegerField(source='id')
...
class CustomerProfileSerializer(serializers.ModelSerializer):
    """Serializes the fields for the endpoint /api/profiles/customer/"""
    user = serializers.IntegerField(source='id')
